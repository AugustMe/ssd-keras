...
from keras.utils import multi_gpu_model # add 2021.1.25
...
class SSD(object):
    _defaults = {
        "model_path"        : 'logs/ep092-two-gpu-after.h5', # 单/双卡训练得到的模型
    ...
    def generate(self):
        ...
        # self.ssd_model = multi_gpu_model(self.ssd_model, gpus=2)  # 单卡的话注释掉,gpus数量
